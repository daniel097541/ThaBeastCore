...
import info.beastsoftware.beastcore.annotations.features.MobHoppersData;
...
public class MobHoppersFeature extends AbstractFeature {
    ...
    public MobHoppersFeature(@MobHoppers IConfig config,
                             @MobHoppersData IConfig dataConfig,
                             @MobHoppers IDataConfig old,
                             BeastCore plugin) {
        super(config, new MobHoppersFeatureListener(config, dataConfig, old), new MobHoppersCommand(plugin, config), FeatureType.MOB_HOPPERS);
